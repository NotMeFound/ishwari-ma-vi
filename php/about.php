...
<div class="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
    ...
    <p class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
        <?= t('Established in 2026 B.S., Ishwari Secondary School serves as a premier government model school dedicated to academic discipline, scientific inquiry, and civic contribution.', 'वि.सं. २०३५ मा स्थापित यो विद्यालय नेपाल सरकारको नमुना विद्यालयको रूपमा समग्र शैक्षिक विकासमा समर्पित छ।') ?>
    </p>
